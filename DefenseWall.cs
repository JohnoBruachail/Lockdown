...
public class DefenseWall : MonoBehaviour {
	...
	public List<DefenseWallTier> tiers;
	private DefenseWallTier currentTier;

	public DefenseWallTier CurrentTier
    {
		get{
			return currentTier;
		}
    ...
    public DefenseWallTier getNextLevel()
    {
        int currentLevelIndex = tiers.IndexOf(currentTier);
